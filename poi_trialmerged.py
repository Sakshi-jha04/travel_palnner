...
def FINAL(Type,Duration,Budget,TYPE,Ques):
  ...
  timepoiplotlydf
  def get_endtime(pid):
    time1 = str(timepoiplotlydf[timepoiplotlydf['PID']==pid]['Finish'].iloc[0])[11:16]
  ...
  def refresh_map():
    m = folium.Map(location=[26.916973348018836,75.82555554188403],tiles='Stamen Toner',zoom_start=13, attr='Map tiles by Stamen Design, under CC BY 3.0. Data by OpenStreetMap, under ODbL.'
)
